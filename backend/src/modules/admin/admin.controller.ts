...
export class AdminController {
  ...
  @ApiOperation({
    ...
    description: 'Returns real-time dashboard statistics calculated from backend data'
  })
  ...
  @ApiQuery({ name: 'role', required: false, enum: ['admin', 'therapist', 'caregiver'] })
  ...
  async deleteUser(
    ...
    return this.adminService.deleteUser(id, admin.sub, body.reason);
  }
